    ...
    <div v-if="!isLogging && wallet">
      <b-navbar>
        ...
        <template slot="start">
          ...
          <b-navbar-item href="/#/drafts">Drafts</b-navbar-item>
          <b-navbar-item href="/#/contracts">Contracts</b-navbar-item>
        </template>
      ...
      <router-view />
      <hr />Scrypta Digital Contracts
      <a
        href="https://github.com/scryptachain/scrypta-contracts"
        target="_blank"
          ...
          <div class="container" id="create" style="margin-top:50px;">
            <div>
              <div style="padding: 50px 20px;">
                ...
                <h1 class="title is-2">Scrypta Digital Contracts</h1>
                <br />
                <h2 class="subtitle">
                  <br />Puoi accedere con Scrypta ID extension o creando una nuova identità
                  <br />
                  <br />Accedi con Scrypta ID Extension o effettua il login con un file sid esistente.
                  <br />
                  <br />
                  <b-upload v-model="file" v-on:input="loadWalletFromFile" drag-drop>
                    <section class="section">
                      <div class="content has-text-centered">
                        <p>Trascina il tuo file .sid qui o clicca su upload</p>
                      </div>
                    </section>
                  </b-upload>
                </h2>
